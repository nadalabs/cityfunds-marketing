...
Nada is an investment, finance, and banking platform that has redefined how everyone accesses real estate assets.‍
Nada was founded on the belief that the financial system built around real estate assets was far too restrictive and unnecessarily complicated. We realized that the industry insiders and the wealthy had an unfair advantage. So, we set out to level the playing field by creating new financial products with transparency and simplicity built into every step.‍
Founded by a couple of non-conformists with the experience and grit to break down these barriers. Co-founder and CEO John Green spent his 20s as a full-time touring & recording punk rocker before his career leading risk and strategy within the mortgage industry. Co-founder and CFO Mauricio Delgado dropped out of Stanford to start his first company at 19 before launching a career spanning Wall Street as CEO of an auto fintech company.
