...
*[_type == "testimonial && category.current == "Nada""] | order(index asc, _updatedAt desc) {
  ${testimonialFields}
}`;

export const homesharesTestimonialsQuery = `
*[_type == "testimonial && category.current == "Cityfunds""] | order(index asc, _updatedAt desc) {
  ${testimonialFields}
}`;
...
*[_type == "value && category.current == "Nada""] | order(index asc, _updatedAt desc) {
  ${valueFields}
}`;

export const cityfundsValuesQuery = `
*[_type == "value && category.current == "Cityfunds""] | order(index asc, _updatedAt desc) {
  ${valueFields}
}`;
...
*[_type == "value && category.current == "Press""] | order(index asc, _updatedAt desc) {
  ${logoFields}
}`;

export const backersLogosQuery = `
*[_type == "value && category.current == "Backer""] | order(index asc, _updatedAt desc) {
  ${logoFields}
}`;
